...
_debug_marker setMarkerAlpha 1;
 ...
 _msgDebug = "<t align='center' color='#FF0000' shadow='2' size='1.75'>Attention!</t><br/><img size='4.75' image='custom\GUI\treasure_hunt\Supply_ICON.paa'/><br/><t align='center' color='#ffffff'>Red Cross plane just droped a crate full clothes, food and medicals. Find it befere anyone else will.</t>";
