...
"TitleText[""Geiger on..."",""PLAIN DOWN""];execVM ""Nuke\Effects\on.sqf"";TTRadZoneEffects = true;",
		
"TitleText[""Geiger off..."",""PLAIN DOWN""];execVM ""Nuke\Effects\off.sqf"";TTRadZoneEffects = false;"
];
