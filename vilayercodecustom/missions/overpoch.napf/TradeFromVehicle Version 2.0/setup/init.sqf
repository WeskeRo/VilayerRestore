...
TFV_ATIS = false;   // Allow toolbelt items to be sold? Toolbelt items are classed as weapons and will be sold without warning when weapons are sold. Keys will ALWAYS be safe.
...
TFV_TAXFBT= "5"; // Dispay Tax Backpack (lazy code TBH)
