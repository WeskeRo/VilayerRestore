...
_infiSZ =
[
	[[8246.7275,15490.344,0],100,true],//Lenzburg
	[[15506.952,13229.368,0],100,true],//Emmen
	[[12399.751,5074.5273,0],100,true],//Schratten
	[[10398.626,8279.4619,0],100,true],//Bandit Camp
	[[5149.9814,4864.1191,0],100,true],//Hero Vendor
	[[2122.7954,7807.9878,0],100,true],//West Wholesaler
	[[5379.0342,16103.187,0],100,true],//East Wholesaler
	[[6772.8877,16983.270,0],100,true],//Boat Vendor1
	[[16839.973,5264.0566,0],100,true],//Boat Vendor2
	[[15128.379,16421.879,0],100,true],//Aircraft Vendor
	[[16419.049,4062.9302,0],200,true]//Revolution Trader
];
			...
			if (_lSign) then
			{
				for '_i' from 0 to 360 step (350 / _radius)*2 do
				{
					...
					//  _object = createVehicle ['Sign_sphere100cm_EP1', _location, [], 0, 'CAN_COLLIDE'];
						...
						_object setVehicleInit 'this setObjectTexture [0,''custom\safezone\safezone1.jpg''];';
					_object setDir _dir;
				};
			};
		} forEach _infiSZ;
